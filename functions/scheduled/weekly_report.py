"""Scheduled function: Generate and send weekly report on Mondays."""
import logging
...
def run_weekly_report():
    """Generate and deliver weekly report for all users with enabled configs."""
    db = get_db()
    ...
    for config_doc in configs:
        ...
        try:
            result = generator.generate(db, user_id, "weekly")
